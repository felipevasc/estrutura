...
CREATE TABLE "new_whatweb_resultados" (
    ...
    CONSTRAINT "whatweb_resultados_portaId_fkey" FOREIGN KEY ("portaId") REFERENCES "portas" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_whatweb_resultados" ("assinatura", "criadoEm", "dados", "diretorioId", "dominioId", "id", "ipId", "plugin", "valor") SELECT "assinatura", "criadoEm", "dados", "diretorioId", "dominioId", "id", "ipId", "plugin", "valor" FROM "whatweb_resultados";
